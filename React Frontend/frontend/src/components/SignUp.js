...
export default class SignUp extends Component {
  ...
  valid() {
    if (this.state.username.length < 4 && (this.state.emailId.length < 9 && this.state.password.length < 6 && this.state.id.length < 9 &&  this.state.role.length < 1 )) {
      this.setState({
        idError: "Mobile number should be 10 digits",
        emailIdError:"Enter Valid EmailID",
      ...
      this.setState({
        emailIdError: "EmailId is not valid"
      })
    }
