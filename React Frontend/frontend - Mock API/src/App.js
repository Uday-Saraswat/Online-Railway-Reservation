...
import navImage from "./resources/navImg1.png";
...
function App() {
  ...
  return (
    <Router>
      <div className="navbar navbar-expand-lg " style={{ backgroundColor: "green", width: "100%", height: "150px" }}>
        <a href="">
          <img src={navImage} />
        </a>
      </div>
      ...
      >
        <center>
          ...
          <div style={{ color: "white" }}>
            ...
            <p className="navbar-text">©2022 Pakistan Railway Tourism (Uday Saraswat) Capgemini Casestudy</p>
          </div>
        </center>
      </div>
    </Router>
